...
export function Chat({ initialMessages, children }: ChatProps) {
  ...
  return (
    <div className="flex flex-col h-full gap-4 p-4 w-full min-w-0 bg-gradient-to-b from-background via-background to-muted/10">
      {children || (
        <>
          <ScrollArea
            className="scroll mb-4 w-full flex-1 min-h-0"
